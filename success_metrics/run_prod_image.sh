...
docker run --name iq_success_metrics --rm -it -v /tmp/sm_output:/usr/src/app/output cmorenoserrano/iq_success_metrics:latest reports.py -f /usr/src/app/output/successmetrics.json -t
